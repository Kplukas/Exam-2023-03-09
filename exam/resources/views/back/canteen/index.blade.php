                ...
                <div class="card-body">
                    <ul class="card-group">
                        ...
                        <li class="col-5 list-group-item m-2 p-2 border border-white border-3 text-center">
                            ...
                            <form action="{{route('canteen-delete', $canteen)}}" method="post">
                                <a class="btn btn-dark btn-outline-light col-sm-12 mt-2" href="{{route('canteen-edit', $canteen)}}">Edit canteen</a>
                                <a class="btn btn-dark btn-outline-light col-sm-12 mt-2" href="{{route('canteen-show', $canteen)}}">Show canteen</a>
                                <button class="btn btn-dark btn-outline-light col-12 mt-2" type="submit">Delete canteen</button>
                                @csrf
                                @method('delete')
                            </form>
                        </li>
