...
Route::prefix('canteen')->name('canteen-')->group(function () {
    ...
    Route::get('/show/{canteen}', [CC::class, 'show'] )->name('show')->middleware('roles:A');
    Route::get('/show2/{canteen}', [CC::class, 'show2'] )->name('show2')->middleware('roles:A|C');
...
Route::prefix('foodlist')->name('foodlist-')->group(function () {
    ...
    Route::get('/show/{foodlist}', [FL::class, 'show'] )->name('show')->middleware('roles:A');
    Route::get('/show2/{foodlist}', [FL::class, 'show2'] )->name('show2')->middleware('roles:A|C');
...
Route::prefix('order')->name('order-')->group(function () {
    ...
    Route::get('/show/{order}', [OC::class, 'show'] )->name('show')->middleware('roles:A');
    Route::get('/show2/{order}', [OC::class, 'show2'] )->name('show2')->middleware('roles:A|C');
